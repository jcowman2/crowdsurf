...
class HelpEvent extends GameEvent {
    ...
    protected List<OutputLine> generateOutput() {
        ...
        output.addAll(
                ...
                OutputLine.normal("It's your job to come up with new lyrics that match the original themes of your songs."),
                OutputLine.normal(""),
                OutputLine.normal("The game consists of 3 songs. At the start of each song, you'll be given a short list of keywords."),
                OutputLine.normal("You're scored based on how well your lyrics relate to these keywords. You can also earn points for having clever rhymes."),
                OutputLine.normal(""),
                ...
                OutputLine.debug("\t*???   - What could this secret command be?")
        )
